      ...
      <View key={index} style={styles.card}>
        ...
        {editing && (
          <View style={styles.editSection}>
            ...
            <TextInput style={styles.input} value={fish.metadata.species_name} placeholderTextColor="#5494d0" onChangeText={(t) => updateField(index, "metadata.species_name", t)} />

            <Text style={styles.label}>Scientific Name</Text>
            <TextInput style={styles.input} value={fish.metadata.species_Nomenclature} placeholderTextColor="#5494d0" onChangeText={(t) => updateField(index, "metadata.species_Nomenclature", t)} />

            <Text style={styles.label}>Quantity</Text>
            <TextInput style={styles.input} keyboardType="numeric" value={fish.quantity} placeholderTextColor="#5494d0" onChangeText={(t) => updateField(index, "quantity", t)} />

            <Text style={styles.label}>Notes</Text>
            <TextInput style={styles.input} value={fish.notes} placeholderTextColor="#5494d0" onChangeText={(t) => updateField(index, "notes", t)} />
          </View>
        )}
      </View>
    );
